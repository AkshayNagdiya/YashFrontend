...
//               {showEditModal ? "Edit Refrigerator" : "Add Refrigerator"}
//             </h2>
...
//         <h2 className="text-xl font-semibold mb-4">Refrigerator Inventory</h2>
...
const Refrigerator = () => {
  ...
  const handleAddVariant = () => {
    // Only add the variant if all fields are filled
    if (variant.color && variant.price && variant.quantity && variant.model) {
      setNewProduct((prev) => ({
        ...prev,
        variants: [...prev.variants, variant],
      }));
